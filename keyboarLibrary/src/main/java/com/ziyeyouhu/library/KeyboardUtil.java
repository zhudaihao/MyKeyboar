...
public class KeyboardUtil {
    ...
    public void initLayoutHeight(LinearLayout layoutView) {
        LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) layoutView
                .getLayoutParams();
...
//        keyboard_view_finish.setOnClickListener(new finishListener());
        if (layoutParams == null) {
            ...
            layoutParams.height = (int) (mActivity.getResources().getDisplayMetrics().heightPixels * SIZE.KEYBOARY_H);
        }
...
//				WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
    ...
    //设置一些不需要使用这个键盘的editTexts,解决切换问题
